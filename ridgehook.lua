...
RunService.RenderStepped:Connect(function()
	LocalPlayer.Character.BodyMovement.Disabled = false
...
Color3.new(1, 0.556863, 0.239216)
local menu
do
	...
	do
		...
		local gunmods = misc.new_sector("gun modifications", "left")
		gunmods.element("Button", "unlimited ammo", nil, function()
		...
		local disablers = misc.new_sector("disablers", "left")
		disablers.element("Button", "anti ragdoll", nil, function()
			local Players = game:GetService("Players")
		...
		vehiclemods.element("Slider", "FR", {default = {min = 1, max = 6, default = 3}})
		vehiclemods.element("Slider", "FL", {default = {min = 1, max = 6, default = 3}})
		vehiclemods.element("Slider", "BR", {default = {min = 1, max = 6, default = 3}})
		vehiclemods.element("Slider", "BL", {default = {min = 1, max = 6, default = 3}})
		
		vehiclemods.element("Button", "vehicle acceleration", nil, function()
...
RunService.Heartbeat:Connect(function()
	for _,Player in next, Players:GetPlayers() do
		...
		--if not IsEnemy(Player) then continue end -- I MODIFIED THIS
...
RunService.RenderStepped:Connect(function()
	...
	if menu.values[4].misc["vehicle modifications"].suspension.Toggle and menu.values[4].misc["vehicle modifications"]["$suspension"].Active then
		for i, v in pairs(workspace.CarStorage:GetChildren()) do
			v.Chassis.Platform.SpringFR.FreeLength = menu.values[4].misc["vehicle modifications"].FR.Slider
		end
		
		for i, v in pairs(workspace.CarStorage:GetChildren()) do
			v.Chassis.Platform.SpringFL.FreeLength = menu.values[4].misc["vehicle modifications"].FL.Slider
		end
		
		for i, v in pairs(workspace.CarStorage:GetChildren()) do
			v.Chassis.Platform.SpringRR.FreeLength = menu.values[4].misc["vehicle modifications"].BR.Slider
		end
		
		for i, v in pairs(workspace.CarStorage:GetChildren()) do
			v.Chassis.Platform.SpringRL.FreeLength = menu.values[4].misc["vehicle modifications"].BL.Slider
		end
	end
